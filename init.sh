...
DISK="ram0"
# The ramdisk is empty on every boot, so format it once on load (format=1).
...
# getty handles termios, controlling terminal and job control for the serial console.
